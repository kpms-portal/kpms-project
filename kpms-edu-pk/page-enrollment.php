...
<!-- PAGE HERO -->
<section class="page-hero" style="background: linear-gradient(160deg, rgba(0,24,64,0.88) 0%, rgba(0,48,135,0.7) 50%, rgba(0,24,64,0.82) 100%), url('https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=1920&q=85') center/cover;">
  <div class="page-hero-label">Join Our Family</div>
  <h1 class="page-hero-title">Apply to KPMS</h1>
  <p class="page-hero-subtitle">Begin your child's journey at Kamal Public Middle School for the 2026–27 academic year.</p>
  <div class="page-breadcrumb"><a href="/">Home</a> / <a href="#">Admission</a> / How to Apply</div>
</section>

<div class="page-content">

  <h2 style="text-align:center;">Admission Process</h2>
  <p style="text-align:center; max-width:650px; margin:0 auto 40px;">Joining KPMS is simple. Follow these four steps to secure your child's place for the upcoming year.</p>

  <div class="info-cards">
    <div class="info-card" style="border-top: 4px solid var(--gold);">
      <span class="info-card-icon">1️⃣</span>
      <h3>Submit Application</h3>
      <p>Fill out the online application form below with your child's details and parent/guardian information.</p>
    </div>
    <div class="info-card" style="border-top: 4px solid #00AEEF;">
      <span class="info-card-icon">2️⃣</span>
      <h3>Campus Visit</h3>
      <p>Schedule a visit to tour our campus, meet teachers, and experience the KPMS environment firsthand.</p>
    </div>
    <div class="info-card" style="border-top: 4px solid #E8443A;">
      <span class="info-card-icon">3️⃣</span>
      <h3>Assessment</h3>
      <p>A friendly, age-appropriate assessment helps us understand your child's learning level and needs.</p>
    </div>
    <div class="info-card" style="border-top: 4px solid var(--blue);">
      <span class="info-card-icon">4️⃣</span>
      <h3>Acceptance</h3>
      <p>You'll receive a decision within 5 business days. Accepted families complete enrollment and pay fees.</p>
    </div>
  </div>

  <!-- Application Form -->
  <h2 style="text-align:center; margin-top:60px;">Application Form — 2026–27</h2>

  <form class="kpms-form">
    ...
    <div class="form-row">
      ...
      <div class="form-group">
        ...
        <input type="text" placeholder="e.g. Khan" required>
      </div>
    </div>
    <div class="form-row">
      <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" placeholder="Name of previous school">
    </div>
    ...
    <div class="form-group">
      ...
      <textarea rows="2" placeholder="Street address, area, city"></textarea>
    </div>
    ...
    <div class="form-group">
      ...
      <select>
        <option value="">Select...</option>
        <option>Family / Friend Referral</option>
    ...
    <div class="form-group">
      <label>Any special needs, allergies, or other information we should know?</label>
      <textarea rows="3" placeholder="Please share anything that will help us support your child..."></textarea>
    </div>

    <div style="text-align:center; margin-top:32px;">
      <button type="button" class="btn btn-primary" style="padding:16px 48px; font-size:16px; border:none; border-radius:12px; background:var(--blue); color:white; font-weight:700; cursor:pointer; transition:all 0.3s; box-shadow: 0 8px 24px rgba(0,48,135,0.2);" onmouseover="this.style.background='var(--blue-deep)';this.style.transform='translateY(-2px)'" onmouseout="this.style.background='var(--blue)';this.style.transform='translateY(0)'">Submit Application</button>
      <p style="margin-top:12px; font-size:13px; color:var(--text-muted);">You'll receive a confirmation email within 24 hours.</p>
    </div>
  </form>

  <!-- Tuition Info -->
  <div style="margin-top:60px; padding:40px; background:var(--cream-warm); border-radius:20px;">
    <h2 style="text-align:center;">Tuition & Fees — 2026–27</h2>
    <p style="text-align:center; max-width:600px; margin:0 auto 24px;">KPMS is committed to making quality education accessible. Our fees are structured to be affordable for Abbottabad families.</p>
    <div class="info-cards">
      <div class="info-card" style="text-align:center;">
        <span class="info-card-icon">📚</span>
        <h3>Monthly Tuition</h3>
        <p style="font-size:28px; font-weight:700; color:var(--blue); font-family:'Playfair Display',serif;">Rs. 4,500</p>
        <p>Includes all core subjects, lunch, and basic supplies</p>
      </div>
      <div class="info-card" style="text-align:center;">
        <span class="info-card-icon">📝</span>
        <h3>Admission Fee</h3>
        <p style="font-size:28px; font-weight:700; color:var(--blue); font-family:'Playfair Display',serif;">Rs. 8,000</p>
        <p>One-time fee covering registration, uniform kit, and books</p>
      </div>
      <div class="info-card" style="text-align:center;">
        <span class="info-card-icon">🎁</span>
        <h3>Sibling Discount</h3>
        <p style="font-size:28px; font-weight:700; color:var(--blue); font-family:'Playfair Display',serif;">15% Off</p>
        <p>Second child onwards receives a discount on monthly tuition</p>
      </div>
    </div>
  </div>
