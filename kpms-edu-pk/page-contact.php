...
<!-- PAGE HERO -->
<section class="page-hero" style="background: linear-gradient(160deg, rgba(0,24,64,0.88) 0%, rgba(0,48,135,0.7) 50%, rgba(0,24,64,0.82) 100%), url('https://images.unsplash.com/photo-1577563908411-5077b6dc7624?w=1920&q=85') center/cover;">
  <div class="page-hero-label">Get in Touch</div>
  <h1 class="page-hero-title">Contact Us</h1>
  <p class="page-hero-subtitle">We'd love to hear from you. Reach out with questions, visit requests, or just to say hello.</p>
  <div class="page-breadcrumb"><a href="/">Home</a> / Contact</div>
</section>
...
<div class="page-content">
  ...
  <div class="info-cards">
    ...
    <div class="info-card" style="text-align:center;">
      <span class="info-card-icon">📞</span>
      <h3>Call Us</h3>
      <p><strong>+92 313 5914700</strong><br>Monday – Saturday<br>8:00 AM – 3:00 PM</p>
    </div>
    <div class="info-card" style="text-align:center;">
      <span class="info-card-icon">✉️</span>
      <h3>Email Us</h3>
      <p style="text-align:left; font-size:14px; line-height:2;">
        <strong>General Inquiries:</strong> <a href="mailto:info@kpms.edu.pk" style="color:var(--blue);text-decoration:none;">info@kpms.edu.pk</a><br>
        <strong>Admissions:</strong> <a href="mailto:admissions@kpms.edu.pk" style="color:var(--blue);text-decoration:none;">admissions@kpms.edu.pk</a><br>
        <strong>Careers:</strong> <a href="mailto:careers@kpms.edu.pk" style="color:var(--blue);text-decoration:none;">careers@kpms.edu.pk</a><br>
        <strong>IT / Technical:</strong> <a href="mailto:itadmin@kpms.edu.pk" style="color:var(--blue);text-decoration:none;">itadmin@kpms.edu.pk</a>
      </p>
    </div>
    <div class="info-card" style="text-align:center;">
      <span class="info-card-icon">💬</span>
      <h3>WhatsApp</h3>
      <p><a href="https://wa.me/+923135914700" style="color:var(--blue); font-weight:700; text-decoration:none;">Chat on WhatsApp →</a><br>Quick questions? Message us directly.</p>
    </div>
  </div>

  <!-- Map -->
  <div style="margin:50px 0; border-radius:20px; overflow:hidden; box-shadow: 0 12px 40px rgba(0,0,0,0.1);">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3308.8!2d73.22!3d34.15!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2sKamal+Public+Middle+School+Abbottabad!5e0!3m2!1sen!2s!4v1234567890" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  </div>

  <!-- Contact Form -->
  <h2 style="text-align:center; margin-top:40px;">Send Us a Message</h2>
  ...
  <form class="kpms-form" id="contactForm" novalidate>
    <input type="hidden" name="form_type" value="contact">
    <div class="form-row">
      <div class="form-group">
        <label>Your Name *</label>
        <input type="text" name="name" placeholder="Full name" required>
        <div class="form-error" style="display:none;color:#e74c3c;font-size:12px;margin-top:4px;">Please enter your name</div>
      </div>
      <div class="form-group">
        <label>Email Address *</label>
        <input type="email" name="email" placeholder="you@example.com" required>
        <div class="form-error" style="display:none;color:#e74c3c;font-size:12px;margin-top:4px;">Please enter a valid email</div>
      </div>
    </div>
    <div class="form-row">
      <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="form-error" style="display:none;color:#e74c3c;font-size:12px;margin-top:4px;">Please enter your message</div>
    </div>
    <div style="text-align:center;">
      <button type="submit" class="btn btn-primary" id="contactSubmitBtn" style="padding:14px 40px; font-size:16px; border:none; border-radius:10px; background:var(--blue); color:white; font-weight:700; cursor:pointer; transition:all 0.3s;">Send Message</button>
    </div>
    <div id="contactFormMsg" style="display:none; text-align:center; margin-top:20px; padding:16px 24px; border-radius:10px; font-weight:600;"></div>
  </form>
  ...
  document.getElementById('contactForm').addEventListener('submit', async function(e) {
    ...
    if (!name.value.trim()) { name.nextElementSibling.style.display = 'block'; valid = false; }
    if (!email.value.trim() || !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email.value)) { email.nextElementSibling.style.display = 'block'; valid = false; }
    if (!message.value.trim()) { message.nextElementSibling.style.display = 'block'; valid = false; }
