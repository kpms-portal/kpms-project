<?php
/*
Template Name: KPMS - Parent Portal
*/
?>
<?php
...
<!-- PAGE HERO -->
<section class="page-hero" style="background: linear-gradient(160deg, rgba(0,24,64,0.88) 0%, rgba(0,48,135,0.7) 50%, rgba(0,24,64,0.82) 100%), url('https://images.unsplash.com/photo-1581726707445-75cbe4bfc7c4?w=1920&q=85') center/cover;">
  <div class="page-hero-label">For Parents</div>
  <h1 class="page-hero-title">Parent Portal</h1>
  <p class="page-hero-subtitle">Stay connected with your child's learning journey at KPMS.</p>
  <div class="page-breadcrumb"><a href="/">Home</a> / <a href="#">Parents</a> / Parent Portal</div>
</section>
...
<div class="page-content">
  ...
  <div class="portal-login">
    ...
    <h2>Welcome Back</h2>
    <p>Sign in to access grades, attendance, and more.</p>
    <form class="kpms-form" style="margin:0;">
      ...
      <button type="button" class="btn btn-primary" style="width:100%; padding:14px; font-size:16px; border:none; border-radius:10px; background:var(--blue); color:white; font-weight:700; cursor:pointer; transition:all 0.3s;" onmouseover="this.style.background='var(--blue-deep)'" onmouseout="this.style.background='var(--blue)'">Sign In</button>
      <p style="margin-top:16px; font-size:13px;"><a href="#" style="color:var(--blue); text-decoration:none;">Forgot password?</a> · <a href="#" style="color:var(--blue); text-decoration:none;">First time? Register here</a></p>
    </form>
  </div>

  <!-- What You Can Access -->
  <h2 style="text-align:center; margin-top:60px;">What You Can Access</h2>
  <p style="text-align:center; max-width:600px; margin:0 auto 20px;">The Parent Portal is your one-stop dashboard for everything related to your child's education at KPMS.</p>

  <div class="portal-features">
    <div class="portal-feature">
      <div class="portal-feature-icon">📊</div>
      <div>
        <h4>Grades & Report Cards</h4>
        <p>View current grades, quarterly report cards, and track academic progress across all subjects throughout the year.</p>
      </div>
    </div>
    <div class="portal-feature">
      <div class="portal-feature-icon">📅</div>
      <div>
        ...
        <p>Monitor daily attendance, view absence history, and submit absence notifications directly to the school office.</p>
      </div>
    </div>
    <div class="portal-feature">
      <div class="portal-feature-icon">💬</div>
      <div>
        ...
        <p>Communicate directly with your child's teachers, receive updates, and schedule parent-teacher meetings.</p>
      </div>
    </div>
    <div class="portal-feature">
      <div class="portal-feature-icon">📋</div>
      <div>
        ...
        <p>See upcoming assignments, project deadlines, and download study materials shared by teachers.</p>
      </div>
    </div>
    <div class="portal-feature">
      <div class="portal-feature-icon">📝</div>
      <div>
        ...
        <p>Access important school forms, permission slips, medical forms, and download documents anytime.</p>
      </div>
    </div>
  </div>
  ...
  <div style="margin-top:60px;">
    <h2 style="text-align:center; margin-bottom:8px; font-family:'Playfair Display',serif; color:var(--text);">Frequently Asked Questions</h2>
    <p style="text-align:center; color:var(--text-muted); margin-bottom:30px;">Common questions about the Parent Portal</p>

    <div style="max-width:800px; margin:0 auto;">
      <details style="background:var(--white); border:1px solid var(--ice); border-radius:12px; margin-bottom:12px; padding:0;">
        <summary style="padding:18px 24px; cursor:pointer; font-weight:600; font-size:15px; color:var(--text); list-style:none; display:flex; justify-content:space-between; align-items:center;">How do I get my login credentials?<span style="color:var(--blue); font-size:18px;">+</span></summary>
        <div style="padding:0 24px 18px; color:var(--text-muted); font-size:14px; line-height:1.7;">Login credentials are provided during the enrollment process. If you haven't received yours, please contact the school office at +92 313 5914700 or email info@kpms.edu.pk.</div>
      </details>
      <details style="background:var(--white); border:1px solid var(--ice); border-radius:12px; margin-bottom:12px; padding:0;">
        <summary style="padding:18px 24px; cursor:pointer; font-weight:600; font-size:15px; color:var(--text); list-style:none; display:flex; justify-content:space-between; align-items:center;">I forgot my password. What should I do?<span style="color:var(--blue); font-size:18px;">+</span></summary>
        <div style="padding:0 24px 18px; color:var(--text-muted); font-size:14px; line-height:1.7;">Click the "Forgot password?" link on the login page to reset your password. You'll receive a reset link via email. If you don't receive it, check your spam folder or contact the office.</div>
      </details>
      <details style="background:var(--white); border:1px solid var(--ice); border-radius:12px; margin-bottom:12px; padding:0;">
        <summary style="padding:18px 24px; cursor:pointer; font-weight:600; font-size:15px; color:var(--text); list-style:none; display:flex; justify-content:space-between; align-items:center;">How often are grades updated?<span style="color:var(--blue); font-size:18px;">+</span></summary>
        <div style="padding:0 24px 18px; color:var(--text-muted); font-size:14px; line-height:1.7;">Grades are updated after each assessment and at the end of each term. Teachers typically update grades within 48 hours of an assessment.</div>
      </details>
      <details style="background:var(--white); border:1px solid var(--ice); border-radius:12px; margin-bottom:12px; padding:0;">
        <summary style="padding:18px 24px; cursor:pointer; font-weight:600; font-size:15px; color:var(--text); list-style:none; display:flex; justify-content:space-between; align-items:center;">Can I message my child's teacher through the portal?<span style="color:var(--blue); font-size:18px;">+</span></summary>
        <div style="padding:0 24px 18px; color:var(--text-muted); font-size:14px; line-height:1.7;">Yes! The Teacher Messages feature allows direct communication with your child's teachers. You can send messages, request meetings, and receive updates about your child's progress.</div>
      </details>
      <details style="background:var(--white); border:1px solid var(--ice); border-radius:12px; margin-bottom:12px; padding:0;">
        <summary style="padding:18px 24px; cursor:pointer; font-weight:600; font-size:15px; color:var(--text); list-style:none; display:flex; justify-content:space-between; align-items:center;">Is the portal available on mobile devices?<span style="color:var(--blue); font-size:18px;">+</span></summary>
        <div style="padding:0 24px 18px; color:var(--text-muted); font-size:14px; line-height:1.7;">Yes, the Parent Portal is fully responsive and works on smartphones, tablets, and computers. Simply visit the portal URL in your mobile browser.</div>
      </details>
    </div>
  </div>

  <div style="text-align:center; margin-top:40px; padding:32px; background:var(--ice); border-radius:16px;">
    <h3 style="margin-top:0;">Need Help?</h3>
    <p>If you're having trouble accessing the portal, please contact the school office.</p>
    <p style="margin:0;"><strong>📞 +92 313 5914700</strong> · <strong>✉ info@kpms.edu.pk</strong></p>
  </div>
